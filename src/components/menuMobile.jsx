...
const MenuMobile= () =>{
  ...
  const list = (anchor) => (
    ...
    >
      <List>
        <img className={Menu.logo} src="https://res.cloudinary.com/dfaaqkh9d/image/upload/v1631387370/logo/41a.amazon_logo_RGB_REV_poj3hr.png"/>
      </List>
         ...
         'Ventas','pendientes','Novedades'].map((text, index) => (
          ...
          <ListItem className={
            menu_item === index ?
             Menu.Cont_active : 
             Menu.cont_item}
             onClick={()=>setMenu_item(index )} button key={index}>
